...
\header{CS/MATH 113}{WC07: Functions and Cardinalities}{Spring 2026}
...
\begin{questions}
    ...
    \begin{parts}
        \part[3] Show that for any $n\in \mathbb{N}$, $S_n$ is finite and $|S_{n+1}| = (n+1) \times |S_n|$.
        \begin{solution}
        ...
        \begin{solution}
            % Enter your solution here
        \end{solution}
        \part[4] Show that $S_{\mathbb{N}}$ is uncountable.
        \begin{solution}
            % Enter your solution here
        \end{solution}
    \end{parts}
